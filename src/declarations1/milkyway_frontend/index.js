...
import { idlFactory } from './milkyway_frontend.did.js';
export { idlFactory } from './milkyway_frontend.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.MILKYWAY_FRONTEND_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./milkyway_frontend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the milkyway_frontend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./milkyway_frontend.did.js")._SERVICE>}
 */
export const milkyway_frontend = createActor(canisterId);
