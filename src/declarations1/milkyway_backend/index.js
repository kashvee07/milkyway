...
export const canisterId = process.env.MILKYWAY_BACKEND_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./milkyway_backend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the milkyway_backend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./milkyway_backend.did.js")._SERVICE>}
 */
export const milkyway_backend = createActor(canisterId);
